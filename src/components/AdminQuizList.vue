  ...
  <div>
    ...
    <div class="w-full max-w-3xl mx-auto">
      <template v-if="quizzes.length === 0">
        <div class="text-gray-500">No quizzes found.</div>
      </template>
      <template v-else>
        <ul class="space-y-2">
          <li
            ...
            :key="quiz.id"
            class="flex items-center justify-between bg-white dark:bg-gray-800 rounded shadow p-4 w-full"
          >
            <div>
              ...
              <div class="text-xs mt-1">
                <span
                  ...
                  >{{ tag }}</span
                >
                <span v-if="quiz.published" class="ml-2 text-green-600 font-semibold">
                  Published
                </span>
