...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <nav class="sticky top-0 z-30 flex items-center gap-4 px-8 py-4 bg-white/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-700 shadow-sm backdrop-blur rounded-b-xl">
      ...
      <router-link v-if="isAuthenticated" to="/leaderboard" class="font-bold text-yellow-700 dark:text-yellow-300 hover:underline focus:outline-none focus:ring-2 focus:ring-yellow-400 px-2 py-1 rounded transition">Leaderboard</router-link>
